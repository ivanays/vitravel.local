    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (!isNaN(response)) {
                ...
                popupWrapperB.empty();
                popupWrapperB.append('<p class="popup__info">Число опрошенных уже превысело <span id="span-numberb" class="popup__number"></span></p><p class="popup__info">До встречи на виртуальной экскурсии!</p>')
